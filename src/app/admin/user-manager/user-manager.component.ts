...
export class UserManagerComponent implements OnInit {
  ...
  newmanager(event, rightId) {
    ...
    if (newcheck === true) {
      this.newUserName.rights.push({ rightId: rightId });
    } else {
      this.newUserName.rights.forEach((x, i) => {
        if (x.rightId === rightId) {
          this.newUserName.rights.splice(i, 1);
        }
      });
    }
  ...
  newgroup(event, groupId) {
    var newcheck = event.target.checked;
    if (newcheck === true) {
      this.newUserName.groups.push({ groupId: groupId });
    } else {
      this.newUserName.groups.forEach((x, i) => {
        if (x.groupId == groupId) {
          this.newUserName.groups.splice(i, 1);
        }
      });
    }
    console.log(this.newUserName);
  ...
  async addUserName() {
    try {
      let res;
      let result;
      res = await this.api.httpCall(
        this.api.apiLists.addNewUser,
        {},
        this.newUserName,
        'post',
        true
  ...
  async DataDulieu() {
    try {
      ...
      let result;
      res = await this.api.httpCall(
        this.api.apiLists.getAllRights,
        {},
        {},
        'get',
        true
  ...
  async individualData(userId: string) {
    try {
      ...
      let result;
      res = await this.api.httpCall(
        this.api.apiLists.getAllRightsByUserld + userId,
        {},
        {},
        'get',
        true
  ...
  async deleteUserName(userId: string) {
    try {
      ...
      let result;
      res = await this.api.httpCall(
        this.api.apiLists.deleteUser + '?' + 'userId' + '=' + userId,
        {},
        {},
        'post',
        true
  ...
  async updateUserName() {
    try {
      ...
      res = await this.api.httpCall(
        this.api.apiLists.updateUserInfo,
        {},
        this.update,
        'post',
        true
  ...
  async assignMultiple() {
    try {
      ...
      let result;
      res = await this.api.httpCall(
        this.api.apiLists.assignMultiRightsToUser,
        {},
        this.quyenvanhom,
        'post',
        true
  ...
  async removeAllRightUser() {
    try {
      ...
      let result;
      res = await this.api.httpCall(
        this.api.apiLists.removeAllRightFromUser,
        {},
        this.quyenvanhom,
        'post',
        true
  ...
  async assignMultiGroupsUser() {
    try {
      ...
      let result;
      res = await this.api.httpCall(
        this.api.apiLists.assignMultiGroupsToUser,
        {},
        this.quyenvanhom,
        'post',
        true
  ...
  async removeMultiGroupUser() {
    try {
      ...
      let result;
      res = await this.api.httpCall(
        this.api.apiLists.removeMultiSelectedGroupsFromUser,
        {},
        this.quyenvanhom,
        'post',
        true
